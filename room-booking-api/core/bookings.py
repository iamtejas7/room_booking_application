...
def compute_free_slots(
    ...
    for booking in confirmed:
        ...
        # Use actual_check_out if present and earlier than end_time
        if getattr(booking, "actual_check_out", None):
            b_end = min(_parse_dt(booking.end_time), _parse_dt(booking.actual_check_out))
        else:
