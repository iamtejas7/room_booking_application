      ...
      <aside className="w-64 flex-shrink-0 flex flex-col border-r border-[#1e2a45] bg-gradient-to-b from-[#0a0f1e] to-[#080b14]">
        ...
        <div className="px-5 pt-6 pb-4 border-b border-[#1e2a45]">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-lg">
              🏢
            </div>
            <div>
              <div className="text-base font-extrabold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                Apexon RoomBook
              </div>
              <div className="text-[0.65rem] text-slate-600 uppercase tracking-widest">Meeting Room Manager</div>
            </div>
          </div>
        </div>
        ...
        <div className="px-3 mb-2">
          <div className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-medium ${
            apiOk ? 'bg-emerald-500/8 border border-emerald-500/20 text-emerald-400'
